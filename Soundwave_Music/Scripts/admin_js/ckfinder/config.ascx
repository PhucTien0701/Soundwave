...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseKey = "A27TA5YXUM5BEJDXWJ4M6UWBH8SN3HYD";
        ...
        type = ResourceType.Add( "Album" );
        type.Url = BaseUrl + "ImagesAlbum/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesAlbum/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Area" );
        type.Url = BaseUrl + "ImagesArea/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesArea/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Composer" );
        type.Url = BaseUrl + "ImagesComposer/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesComposer/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Genre" );
        ...
        type = ResourceType.Add( "ImagesCollection" );
        type.Url = BaseUrl + "ImagesImagesCollection/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesImagesCollection/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Singer" );
        type.Url = BaseUrl + "ImagesSinger/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesSinger/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Song" );
        type.Url = BaseUrl + "ImagesSong/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesSong/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "Supplier" );
        type.Url = BaseUrl + "ImagesSupplier/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesSupplier/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "SongUpload_mp3" );
        type.Url = BaseUrl + "SongUpload_mp3/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "SongUpload_mp3/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "mp3" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add( "MVUpload_mp4" );
        type.Url = BaseUrl + "MVUpload_mp4/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "MVUpload_mp4/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "mp4" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "News" );
        type.Url = BaseUrl + "ImagesNews/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesNews/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
